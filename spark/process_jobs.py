...
# from pyspark.sql.functions import col, lower, split, udf
...
# # 🧠 SKILL EXTRACTION
# # -------------------------------
# from pyspark.sql.functions import col, lower, array, when

# # -------------------------------
# # 🧠 SKILL EXTRACTION (NO UDF 🔥)
# # -------------------------------
# SKILL_DB = [
...
# # df = df.withColumn("skills", extract_skills_udf(col("description")))
